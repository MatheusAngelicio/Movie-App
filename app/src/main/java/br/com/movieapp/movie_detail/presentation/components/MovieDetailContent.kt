...
import br.com.movieapp.movie_detail.data.mapper.toMovie
...
fun MovieDetailContent(
    ...
    Box(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                //pra esse column ocupar 60% da tela do usuario de forma dinamica
                .fillMaxHeight(0.6f)
        ...
        MovieDetailSimilarMovies(
            ...
            modifier = Modifier
                .fillMaxWidth()
                // pra ocupar 35% da tela, alinhado la em baixo
                .fillMaxHeight(0.35f)
